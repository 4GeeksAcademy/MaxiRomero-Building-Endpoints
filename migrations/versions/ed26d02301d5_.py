...
Revision ID: ed26d02301d5
Revises: c7b3c0cec6a2
Create Date: 2024-10-03 19:37:12.043616
...
revision = 'ed26d02301d5'
down_revision = 'c7b3c0cec6a2'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    with op.batch_alter_table('people', schema=None) as batch_op:
        batch_op.add_column(sa.Column('url', sa.String(length=450), nullable=False))
